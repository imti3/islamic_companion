package com.imtiaj.islamiccompanion.Service;
...
import com.imtiaj.islamiccompanion.Appcompany.App;
import com.imtiaj.islamiccompanion.DatabaseHelper.DatabaseAccess;
import com.imtiaj.islamiccompanion.MainActivity;
import com.imtiaj.islamiccompanion.Model.DuaModel;
import com.imtiaj.islamiccompanion.PrayerAlarmActivity;
...
import com.imtiaj.islamiccompanion.TodayDuaActivity;
...
public class PrayerTimeService extends Service {
    ...
    public void showNotification(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            startForeground(2, new NotificationCompat.Builder(this, App.CHANNEL_ID).setContentTitle("Prayer Time Running").setPriority(1).setContentText("Service Started").setSmallIcon(R.drawable.noti_icon2).setContentIntent(activity).setCategory(Context.ALARM_SERVICE).build());
        } else {
            ((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).notify(2, new NotificationCompat.Builder(this).setContentTitle("Prayer Time Service Running").setPriority(1).setContentText("Service Started").setSmallIcon(R.drawable.noti_icon2).setContentIntent(activity).setCategory(Context.ALARM_SERVICE).build());
        }
    }
    ...
    public class PrayerTimeReceiver extends BroadcastReceiver {
        ...
        private void duaNotification(Context context) {
            ...
            ((NotificationManager) PrayerTimeService.this.getSystemService(Context.NOTIFICATION_SERVICE)).notify(112, new NotificationCompat.Builder(context, App.CHANNEL_ID).setSmallIcon(R.drawable.nicon).setStyle(new NotificationCompat.DecoratedCustomViewStyle()).setContentIntent(activity).setCustomContentView(remoteViews).build());
        }
