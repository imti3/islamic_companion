package com.imtiaj.islamiccompanion.Adapter;
...
public class DhikrAdapter extends RecyclerView.Adapter<DhikrAdapter.AlbumViewHolder> {
    ...
    public void onBindViewHolder(AlbumViewHolder albumViewHolder, final int i) {
        ...
        albumViewHolder.tvDhikrBanglaMeaning.setText(this.list.get(i).getDhikrBanglaMeaning());
    ...
    public class AlbumViewHolder extends RecyclerView.ViewHolder {
        ...
        AlbumViewHolder(View view) {
            ...
            this.tvDhikrBanglaMeaning=(TextView)view.findViewById(R.id.tvDhikrBlMeaning);
