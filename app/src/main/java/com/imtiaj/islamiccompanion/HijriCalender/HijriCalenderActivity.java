package com.imtiaj.islamiccompanion.HijriCalender;
...
import com.imtiaj.islamiccompanion.Aboutdev;
...
public class HijriCalenderActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        int currentMonth = calendar.get(Calendar.MONTH) + 1; // Add 1 because months are zero-based
        ...
        int position = asList2.indexOf(String.valueOf(currentYear));
        ...
        this.sp1.setSelection(currentMonth -1);
...
this.sp2.setSelection(position);
        ...
        this.datePickerDialog = new DatePickerDialog(this, onDateSetListener, calendar3.get(Calendar.YEAR), calendar3.get(Calendar.MONTH), calendar3.get(Calendar.DAY_OF_MONTH));
