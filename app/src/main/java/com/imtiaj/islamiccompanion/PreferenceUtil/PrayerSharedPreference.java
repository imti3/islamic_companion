...
public class PrayerSharedPreference {
    ...
    public String getLatitude() {
        return this.sharedPreferences.getString("Latitude", "22.991859");
    }
    ...
    public String getLongitude() {
        return this.sharedPreferences.getString("Longitude", "91.389687");
    }
    ...
    public boolean getFajrRing() {
        return this.sharedPreferences.getBoolean("FajrRing", false);
    }
    ...
    public boolean getSunriseRing() {
        return this.sharedPreferences.getBoolean("SunriseRing", false);
    }
    ...
    public boolean getDururRing() {
        return this.sharedPreferences.getBoolean("DururRing", false);
    }
    ...
    public boolean getAsrRing() {
        return this.sharedPreferences.getBoolean("AsrRing", false);
    }
    ...
    public boolean getMaghribRing() {
        return this.sharedPreferences.getBoolean("MaghribRing", false);
    }
    ...
    public boolean getIshaRing() {
        return this.sharedPreferences.getBoolean("IshaRing", false);
    }
}
