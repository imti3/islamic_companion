package com.imtiaj.islamiccompanion.DatabaseHelper;
...
public class DatabaseAccess {
    ...
    public List<AlQuranCategoryModel> getAlQuranCategory() {
        ...
        while (!rawQuery.isAfterLast()) {
            ...
            alQuranCategoryModel.setBanglaName(rawQuery.getString(5));
    ...
    public List<AlQuranDataModel> getAlQuranData(int i) {
        ...
        while (!rawQuery.isAfterLast()) {
            ...
            alQuranDataModel.setAyahBangla(rawQuery.getString(6));
            try {
    ...
    public List<DhikrModel> getAllDhikr() {
        ...
        while (!rawQuery.isAfterLast()) {
            ...
            dhikrModel.setDhikrBanglaMeaning(rawQuery.getString(5));
